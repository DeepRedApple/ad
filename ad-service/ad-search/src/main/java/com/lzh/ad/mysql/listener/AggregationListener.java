...
import com.lzh.ad.mysql.TemplateHolder;
...
public class AggregationListener implements BinaryLogClient.EventListener {
	...
	public void  register(String _dbName, String _tableName, Ilistener ilistener) {
		log.info("register - dbName:{}, tableName:{}", _dbName, _tableName);
	...
	public void onEvent(Event event) {
		...
		if (type != EventType.EXT_DELETE_ROWS && type != EventType.EXT_WRITE_ROWS && type != EventType.EXT_DELETE_ROWS) {
			return;
		}
	...
	private BinlogRowData buildRowData(EventData eventData) {
		...
		getAfterValues(eventData).forEach(after -> {
